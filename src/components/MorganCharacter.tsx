...
export default function MorganCharacter({
  ...
  return (
    ...
    >
      ...
      >
        {/* Animated Fruit Flies (Drosophila) buzzing around Morgan */}
        <g className="animate-pulse">
          {/* Fly 1 */}
          <g transform="translate(105, 20)">
            <ellipse cx="0" cy="0" rx="3.5" ry="2" fill="#78350f" />
            <ellipse cx="-2" cy="-3" rx="4" ry="2" fill="#bae6fd" opacity="0.8" transform="rotate(-20)" />
            <ellipse cx="2" cy="-3" rx="4" ry="2" fill="#bae6fd" opacity="0.8" transform="rotate(20)" />
            <circle cx="3" cy="0" r="1.5" fill="#ef4444" /> {/* Red eye */}
          </g>
          {/* Fly 2 */}
          <g transform="translate(120, 36)">
            <ellipse cx="0" cy="0" rx="2.8" ry="1.6" fill="#78350f" />
            <ellipse cx="-1" cy="-2.5" rx="3" ry="1.5" fill="#bae6fd" opacity="0.8" />
            <circle cx="2.2" cy="0" r="1" fill="#ef4444" /> {/* Red eye */}
          </g>
        </g>
        ...
        {/* Torso: Tweed Vest, Rolled Shirt, Tie */}
        <g id="morgan-torso">
          {/* White Shirt base */}
          <path
        ...
        {/* Head & Morgan's Trademark Features (Hair, Glasses, Mustache) */}
        <g id="morgan-head">
          {/* Neck */}
          <rect x="79" y="48" width="10" height="12" fill="#fbcfe8" rx="2" />

          {/* Head Shape */}
          <circle cx="84" cy="38" r="16" fill="#fed7aa" stroke="#f97316" strokeWidth="0.8" />

          {/* Graying / Dark Brown Professor Hair */}
          <path
